...
setup(
    name='''ckanext-ukds_custom_dcat_profiles''',
    ...
    description='''Extension with custom profiles for dcat extension''',
    long_description=long_description,
    long_description_content_type="text/markdown",

    # The project's main homepage.
    url='https://github.com/JiscSD/ckanext-ukds_custom_dcat_profiles',

    # Author details
    author='''Allan Figueroa''',
    author_email='''allan.figueroadelatorre@jisc.ac.uk''',
